...
class TestClasses(unittest.TestCase):
    ...
    def test_Recursives(self):
        recur = Recursives()
        self.assertEqual(recur.factorial(0), 1)
        self.assertEqual(recur.fibonacci(0), 0)
        self.assertEqual(recur.factorial(1), 1)
        self.assertEqual(recur.fibonacci(1), 1)
        self.assertEqual(recur.factorial(2), 2)
        self.assertEqual(recur.fibonacci(2), 1)
